...
class Question {
    ...
    appendQuestion(parent, qNum) { // appends the question (and its answers) to a parent wrapper
        this.parent = parent;
        this.qElement = document.createElement("p");
        this.qElement.innerText = "Question "+qNum+": "+this.question;
...
class Round {
    ...
    displayQuestion() { // displays the question in the parent according to round count
        this.questions[this.roundCount].appendQuestion(this.parent, this.roundCount + 1);

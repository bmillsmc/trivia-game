...
class Round {
    constructor(questions, parent, buttonBox) { // takes in an array of Question objects and a parent wrapper reference, and a button box reference
        this.parent = parent;
...
let round1 = new Round(qArray, triviaGame, buttonBox);
let button = document.createElement("a");

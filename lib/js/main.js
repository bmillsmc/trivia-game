...
class Round {
    ...
    displayQuestion() { // displays the next question in the parent according to round count
    ...
    checkFinish() { // checks to see if a round is finished based on length and the count, if it is calls roundFinish

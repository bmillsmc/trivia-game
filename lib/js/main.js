...
class Game {
    ...
    createDropDown() { // takes an array of options and a title? (maybe if need to retrieve), returns a select wrapper with options appended and default as any catagory
